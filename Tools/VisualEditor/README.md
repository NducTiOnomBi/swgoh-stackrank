...
- **Multi-Tier Display**: Each card shows:
  ...
  - **Best Std**: Best standard synergy tier (if synergies defined)
  - **Best Omi**: Best omicron synergy tier (if omicron synergies defined)
- **Tooltips**: Hover over synergy tiers to see calculation breakdown

### Character Details (Left Sidebar)
- View/edit base tier (1-19)
- View/edit omicron enhancement (0-10)
...
### Base Tier
The character's assigned tier without any synergies.

### Standard Synergy Tier
```
Base Tier - Omicron Enhancement - Best Synergy Enhancement = Standard Tier
```

**Example:**
- Base Tier: 5
- Omicron Enhancement: 2
- Best Synergy Enhancement: 3 (from specific team)
- **Standard Tier: 5 - 2 - 3 = 0** (Tier 0 = off-the-charts good)

### Omicron Synergy Tier
```
Base Tier - Omicron Enhancement - Best Omicron Enhancement = Omicron Tier
```

**Example:**
- Base Tier: 8
- Omicron Enhancement: 1
- Best Omicron Enhancement: 4 (when with omicron-enabled team)
- **Omicron Tier: 8 - 1 - 4 = 3**

### Tooltip Breakdown
Hover over any calculated tier to see:
```
Base Tier (8)
- Omicron Enhancement (1)
...
2. **Category Notation**: `4× Clone Trooper` (means 4 other team members with "Clone Trooper" tag)
...
6. ✅ Omicron enhancement range: 0-10
